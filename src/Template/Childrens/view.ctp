...
<nav class="large-3 medium-4 columns" id="actions-sidebar">
    <ul class="side-nav">
        ...
        <li><?= $this->Html->link(__('New Childrens'), ['action' => 'add']) ?> </li>
...
<div class="childrens view large-9 medium-8 columns content">
    ...
    <table class="vertical-table">
        <tr>
            ...
            <td><?= $children->has('user') ? $this->Html->link($children->user->id, ['controller' => 'Users', 'action' => 'view', $children->user->id]) : '' ?></td>
        </tr>
        <tr>
            <th scope="row"><?= __('Gender') ?></th>
            <td><?= h($children->gender) ?></td>
        </tr>
        <tr>
        ...
        <tr>
            ...
            <td><?= $this->Number->format($children->image) ?></td>
