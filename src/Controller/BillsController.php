...
class BillsController extends AppController
{
    ...
    public function view($id = null)
    {
        $bill = $this->Bills->get($id, [
            'contain' => ['RefBillStatus', 'Users', 'Payments']
        ]);
    ...
    public function add()
    {
        ...
        $refBillStatus = $this->Bills->RefBillStatus->find('list', ['limit' => 200]);
        $users = $this->Bills->Users->find('list', ['limit' => 200]);
        $this->set(compact('bill', 'refBillStatus', 'users'));
    }
